...
gulp.task("compose", shell.task([
    ...
    'docker push cloudhack/openflownodered:edge cloudhack/openflownodered:' + version,       //'docker push cloudhack/openflownodered:' + version,
    ...
    'docker push cloudhack/openflow:edge push cloudhack/openflow:' + version
]));
